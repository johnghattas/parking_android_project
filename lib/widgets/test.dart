...
class NumberFormatter extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _NumberFormatterDemo();
...
class _NumberFormatterDemo extends State {
  ...
  String _activity = '+1';
  PhoneFormatter _phoneNumberFormatter =
  PhoneFormatter(1);
                    ...
                    child: DropdownButton(
                      ...
                      onChanged: (String newValue) {
                        setState(() {
                          ...
                          switch(newValue){
                            case '+1':
                              _phoneNumberFormatter = PhoneFormatter(1);
                              break;
                            case '+91':
                              _phoneNumberFormatter = PhoneFormatter(91);
                              break;
                          }
                        });
                      },
...
class PhoneFormatter extends TextInputFormatter {
  int _whichNumber;
  PhoneFormatter(this._whichNumber);
